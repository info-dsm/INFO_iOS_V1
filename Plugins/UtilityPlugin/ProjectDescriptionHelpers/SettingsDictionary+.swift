...
public extension SettingsDictionary {
    ...
    func setProvisioningDevelopment() -> SettingsDictionary {
        merging(["PROVISIONING_PROFILE_SPECIFIER": SettingValue(stringLiteral: "INFO iOS Debug")])
            .merging(["PROVISIONING_PROFILE": SettingValue(stringLiteral: "INFO iOS Debug")])
    }
    
    func setProvisioningAppstore() -> SettingsDictionary {
        merging(["PROVISIONING_PROFILE_SPECIFIER": SettingValue(stringLiteral: "INFO iOS Release")])
            .merging(["CODE_SIGN_IDENTITY[sdk=iphoneos*]": SettingValue(stringLiteral: "iPhone Distribution")])
            .merging(["PROVISIONING_PROFILE": SettingValue(stringLiteral: "INFO iOS Release")])
    }
}
